...
include 'controllers/nazioniadulti.controller.php';
include 'config/header.inc.php';
include 'config/navmenu.inc.php';


echo '</br>';
echo '<h1>Destinazioni per adulti (18+)</h1>';
...
if (is_array($nazioniAdulti) || is_object($nazioniAdulti))
{
    foreach ($nazioniAdulti as $item) {
        ...
        echo '<a href="cittaadulti.php?nazione=' . $item->nome . '">';
        ...
        echo '<a href="cittaadulti.php?nazione=' . $item->nome . '" class="btn btn-primary">Scopri le città</a>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
    }
